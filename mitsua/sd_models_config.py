...
sd_repo_configs_path = os.path.join(paths.paths['Stable Diffusion'], "configs", "mitsua-diffusion")


config_default = shared.sd_default_config
config_sd2 = os.path.join(sd_repo_configs_path, "mitsua-diffusion-one.yaml")
config_sd2v = os.path.join(sd_repo_configs_path, "mitsua-diffusion-one.yaml")
